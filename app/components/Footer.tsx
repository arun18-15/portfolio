      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="flex justify-center gap-4 md:gap-6 mt-10 md:mt-12">
          <Link
            ...
            className="w-14 h-14 flex items-center justify-center rounded-full bg-white/10 hover:bg-white/20 border border-purple-500/30 hover:border-purple-500/50 transition-all"
