...
- **Project Showcase**: Featured projects section with detailed descriptions and backend/frontend skills
...
```bash
git clone https://github.com/arun18-15/portfolio.git
